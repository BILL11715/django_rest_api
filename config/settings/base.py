...
try:
    if conf('DJANGO_SETTINGS_MODULE') == 'config.settings.local':
        config = Config(RepositoryEnv('local.env'))
    elif conf('DJANGO_SETTINGS_MODULE') == 'config.settings.staging':
        config = Config(RepositoryEnv('staging.env'))
    elif conf('DJANGO_SETTINGS_MODULE') == 'config.settings.production':
